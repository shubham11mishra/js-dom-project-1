...
var clothingWrapper = document.createElement("section");
clothingWrapper.id = "clothingWrapper";
appBody.appendChild(clothingWrapper);

// cloth heading
var clothHeading = document.createElement("h2");
clothHeading.className = "heading";
clothHeading.innerText = "Clothing for Men and Women";
clothingWrapper.appendChild(clothHeading);

// cloth wapper
var clothWapper = document.createElement("div");
clothWapper.className = "card-wrapper";
clothWapper.id = "clothing";
clothingWrapper.appendChild(clothWapper);

var accessoriesWrapper = document.createElement("section");
accessoriesWrapper.id = "accessoriesWrapper";
appBody.appendChild(accessoriesWrapper);
// Accessories  heading
var accessoriesHeading = document.createElement("h2");
accessoriesHeading.className = "heading";
accessoriesHeading.innerText = "Accessories for Men and Women";
clothingWrapper.appendChild(accessoriesHeading);

var accessoriesCardWapper = document.createElement("div");
accessoriesCardWapper.className = "card-wrapper";
accessoriesCardWapper.id = "accessories";
accessoriesWrapper.appendChild(accessoriesCardWapper);
...
productList.forEach(function (products) {
  ...
  cardImg.setAttribute('src',products.preview);
  ...
  cardDetail.appendChild(productName);

  var productBrand =document.createElement('h4');
  productBrand.innerText = products.brand;
  cardDetail.appendChild(productBrand);

  var productPrice = document.createElement('h5');
  productPrice.innerText ='Rs ' + products.price;
  cardDetail.appendChild(productPrice);
  card.appendChild(cardDetail);

  if (products.isAccessory) {
    accessoriesCardWapper.appendChild(card);
  } else {
    clothWapper.appendChild(card);
  }
});
